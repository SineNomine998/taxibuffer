...
class TermsOfUsePreviewScreen extends StatefulWidget {
  const TermsOfUsePreviewScreen({super.key});

  @override
  State<TermsOfUsePreviewScreen> createState() =>
...
class _TermsOfUsePreviewScreenState extends State<TermsOfUsePreviewScreen> {
  ...
  void _accept() {
    ...
    context.read<SignupFormState>().acceptTermsOfUse(policy.version);
    context.pop();
  }
